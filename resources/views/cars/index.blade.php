    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Pricelist</span>
                <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 mt-2">Armada Mobil Kami</h1>
                <p class="text-slate-600 mt-4 max-w-2xl mx-auto">Pilih mobil yang sesuai kebutuhan perjalanan Anda. Semua harga include sopir profesional.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-slate-100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-emerald-600 font-bold text-2xl mb-3">Rp {{ number_format($car->price, 0, ',', '.') }}/hari</p>
                        <p class="text-slate-500 text-sm mb-4 line-clamp-2">{{ $car->description }}</p>
                        <a href="{{ whatsapp_booking_url('mobil', $car->name) }}" target="_blank" class="inline-flex items-center justify-center gap-2 w-full py-3 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-colors">

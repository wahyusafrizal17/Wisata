    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <a href="{{ contact_instagram_url() }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 mt-6 text-brand-600 font-semibold hover:text-brand-700">

...
@section('title', 'Dokumentasi - SMJ Rent')
@section('description', 'Dokumentasi perjalanan dan momen bersama SMJ Rent.')
    ...
    <section class="py-16 lg:py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h1 class="text-4xl lg:text-5xl font-bold text-slate-900 mt-2">{{ $documentation?->title ?: 'Dokumentasi Perjalanan' }}</h1>
                <p class="text-slate-600 mt-4 max-w-2xl mx-auto">{{ $documentation?->subtitle ?: 'Momen-momen indah dari perjalanan bersama SMJ Rent' }}</p>
                @if($documentation?->instagram_url)
                <a href="{{ $documentation->instagram_url }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 mt-6 text-brand-600 font-semibold hover:text-brand-700">

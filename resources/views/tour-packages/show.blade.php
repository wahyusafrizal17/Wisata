    ...
    <section class="py-16 lg:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                    <span class="text-brand-600 font-semibold text-sm uppercase">{{ $package->category }}</span>
                    ...
                    <div class="flex gap-4 mb-6">
                        ...
                        <span class="text-2xl font-bold text-brand-600">Rp {{ number_format($package->price, 0, ',', '.') }}/org</span>
                    </div>
                    ...
                    <a href="{{ whatsapp_booking_url('paket', $package->title) }}" target="_blank" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-brand-600 to-brand-500 text-white font-semibold rounded-xl hover:from-brand-700 hover:to-brand-600 transition-colors shadow-lg shadow-brand-600/25">

    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contact['whatsapp'] ?? '') }}" target="_blank" class="flex items-center gap-2 hover:text-brand-700 transition-colors">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ $contact['instagram'] }}" target="_blank" class="w-10 h-10 rounded-full bg-white ring-1 ring-slate-200 flex items-center justify-center hover:bg-brand-600 hover:text-white hover:ring-brand-600 transition-colors">
                    ...
                    <a href="{{ $contact['linktree'] }}" target="_blank" class="w-10 h-10 rounded-full bg-white ring-1 ring-slate-200 flex items-center justify-center hover:bg-brand-600 hover:text-white hover:ring-brand-600 transition-colors">
